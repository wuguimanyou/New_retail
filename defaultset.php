...
function changeProductType2(pro_typeid,d_id){
 ...
 /*11.3增加*/
<?php if($template_id==47 or $template_id==48 or $template_id==50){?> 
window.onload=function(){
	...
	<?php
		...
		if($_GET['producttype_id']){
			...
			$result_typeid=mysql_query($typeid_query) or die ('typeid_query faild' .mysql_error());
			while($row=mysql_fetch_object($result_typeid)){
				...
				if($pro_typeid){
					...
					$result_pro_typeid=mysql_query($pro_typeid_query) or die ('pro_typeid_query faild' .mysql_error());
...
/*function changeProductType_cat_pro(pro_typeid,d_id){
	alert(d_id);
	 p_detail_id = d_id;
	 //是产品分类
	 url='get_product_list.php?callback=jsonpCallback_get_product_list_catindex&type_id='+pro_typeid;
...
<?php }else if($template_id==18){?>
   ...
   <div  id="shop_skin_index"  <?php if(!empty($index_bg)){ ?>style="background:#<?php echo $index_bg; ?>"<?php } ?>>
	<div  class="shop_skin_index_list banner"  rel="edit-t01"  no="0">
		<div  class="img"><img  src="fruit/fengge47/images/banner.jpg"></div>
		<div  class="mod"  style="display: none;">&nbsp;</div>
...
<?php }else if($template_id==19){?>
    ...
    <style>
		...
		.sub-nav.nav-b5{width:100%;}/*320px改成100%*/
...
<link href="fengge44/shop.css" rel="stylesheet" type="text/css">
<link href="fengge44/index.css?ver=<?php echo time();?>" rel="stylesheet" type="text/css">
<link rel="stylesheet" href="fengge44/base_index.css">
<link rel="stylesheet" href="fengge44/showcase_index.css">
<link rel="stylesheet" href="fengge44/index_36.css">
<link href="fengge44/PreFoot.css" rel="stylesheet" type="text/css">
<script type="text/javascript" src="js/shop.js"></script>
...
<?php }else if($template_id==46){?>
	<link href="css/shop.css" rel="stylesheet" type="text/css">	
	<link rel="stylesheet" type="text/css" href="fengge46/css/global.css">
	<link rel="stylesheet" type="text/css" href="fengge46/css/style.css">
	<div id="shop_skin_index" <?php if(!empty($index_bg)){ ?>style="background:#<?php echo $index_bg; ?>"<?php } ?>>
        ...
        <ul>
            <li class="mp-flexbox mp-hot-prod mp-border-bottom">
                <div class="mp-hotlist-img">
                    <img src="fengge46/img/default.png">					
                </div>
...
<link href="css/shop.css" rel="stylesheet" type="text/css">	
<link rel="stylesheet" type="text/css" href="fengge47/css/style.css">
<div id="shop_skin_index" <?php if(!empty($index_bg)){ ?>style="background:#<?php echo $index_bg; ?>"<?php } ?>>
	<div class="main">
		<div class="search-box">
			<div class="shop_skin_index_list"  rel="edit-t01" no="0">
		...
		<div class="product-box">
			<img src="fengge47/images/title.png" class="title">
			<span class="more">更多>></span>
		...
		<div style="display:block;overflow:hidden;width:320px;">
			<img src="fengge47/images/ad-1.jpg" class="w50-img">
			<img src="fengge47/images/ad-1.jpg" class="w50-img">
		</div>
		<div class="shop_skin_index_list" rel="edit-t30" no="29">
...
<link href="css/shop.css" rel="stylesheet" type="text/css">	
<link rel="stylesheet" href="fengge48/shop.css">
<link rel="stylesheet" href="fengge48/index.css">
<link rel="stylesheet" type="text/css" href="fengge48/amazeui.css">
...
<?php } ?>
  ...
  <script type="text/javascript" src="../common/js/jscolor/jscolor.js"></script>
		<form id="frm_uploadimg" action="save_templateimg.php?customer_id=<?php echo $customer_id_en; ?>&template_id=<?php echo $template_id; ?>" method="post" enctype="multipart/form-data">
				...
				<div class="item">
					...
					<div class="rows">
						...
						<div class="b_r" id="banner_img_3">
						   <a href="fengge47/images/banner.jpg" target="_blank">
						   <img src="fengge47/images/banner.jpg">
						   </a>
						</div>
			...
			<div id="set_title" style="display: none;">
				<div class="item">
					<div value="title">
						<span class="fc_red">*</span> 标题<br>
						<div class="input"><input name="title" value="" id="title_3" type="text" onchange="check_value()"></div>
						<div class="blank20"></div>  
					</div>
					<div style="padding-left:10px;height:30px;line-height:30px;">
						
						字体颜色：<input class="color" value="<?php echo $font_color;?>" name="font_bg" id="font_bg">&nbsp;
    ...
    <?php if($template_id==38 or $template_id==31 or $template_id==45 or $template_id==49){?>   
	...
	?>  
	<style>  
		.fenlei_a{width:140px;height:30px;line-height:30px;font-size:16px;color:#fff;background:#5bb75b;display:block;border-radius:4px;margin:3px 0px;text-align:center;text-decoration:none;overflow:hidden;}				
...
<div style="display:block;overflow:hidden;">
   <!--分类图片41模板专用-->
    <?php if($template_id==41 || $template_id==43 || $template_id==46 || $template_id==38){?>   
    <?php 	
	$producttype_id=-1;
	$btn="添加分类";
	if(!empty($_GET["producttype_id"])){
	...
	<div class="m_righter" ><!--m_righter begin-->
		<form id="frm_producttype" class="" action="save_catindex_img.php?customer_id=<?php echo $customer_id_en; ?>&adminuser_id=<?php echo $adminuser_id; ?>&owner_general=<?php echo $owner_general; ?>&orgin_adminuser_id=<?php echo $orgin_adminuser_id; ?>" method="post" enctype="multipart/form-data" style="margin:5px 10px;">
			...
			<div class="">	
               ...
               <span style="text-align:center;display:block;font-size:16px;">首页分类图片上传尺寸：302px*201px</span>
				<div class="opt_item">
					<label></label>
					<span class="input">				
						<input type="submit" name="submit_button" class="imgbtnsub" value="<?php echo $btn;?>" title="<?php echo $btn;?>" style="width:140px;height:28px;line-height:28px;background:url(images/ok-btn-bg.jpg);cursor:pointer;color:#fff;margin-bottom:10px;">
		...
		<form id="frm_producttype" class="" action="save_producttype_img.php?customer_id=<?php echo $customer_id_en; ?>&adminuser_id=<?php echo $adminuser_id; ?>&owner_general=<?php echo $owner_general; ?>&orgin_adminuser_id=<?php echo $orgin_adminuser_id; ?>" method="post" enctype="multipart/form-data" style="margin:5px 10px;">
			...
			<div class="">	
                <div class="opt_item">			
					...
					<input type="hidden" name="temp47" id="temp47" value="1" /><!--作为47模板的标识-->
                </div>
                <div class="opt_item">				
                    <input type="hidden" id="keyid" name="keyid" value="<?php echo $producttype_id;?>">					
                	<div class="clear"></div>
                ...
                <div class="url_select1" style="">
						...
						<div id="div_products_cat" style="<?php if(!$protypeid){echo "display:none;";}?>">
...
<?php if($template_id==31 or $template_id==45 or $template_id==49){?>
	<style>
							...
							<label>导航栏链接：</label>
								<div class="input"> 
									<select  name="navigation_id"  id="navigation_id">
										...
										<option value="-5" <?php if($pre_navigation_id==-10){ ?> selected="selected" <?php } ?> >限时抢购</option>
								...
								?>
									...
									<li>
										<select  name="Submenulink[]">
											...
											<option value="-5" <?php if($links_separate[$j]==-10){?> selected="selected"<?php } ?> >限时抢购</option>
