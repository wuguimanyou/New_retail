...
if(!empty($_SESSION['auth_style'])){
	...
	switch($auth_style[0]){
			case 1:
				header("Location: base.php?customer_id=".$customer_id."");exit;
			break;
			case 2:
				header("Location: fengge.php?customer_id=".$customer_id."");exit;
			break;
			case 4:
				header("Location: product.php?customer_id=".$customer_id."");exit;
			break;
			case 5:
				header("Location: order.php?customer_id=".$customer_id."");exit;
			break;
			case 6:
				header("Location: supply.php?customer_id=".$customer_id."");exit;
			break;
			case 7:
				header("Location: agent.php?customer_id=".$customer_id."");exit;
			break;
			case 8:
				header("Location: qrsell.php?customer_id=".$customer_id."");exit;
			break;
			case 9:
				header("Location: customers.php?customer_id=".$customer_id."");exit;
			break;
			case 10:
				header("Location: publicwelfare.php?customer_id=".$customer_id."");exit;
			break;
		}
	}
}
...
<div class="iframe_content">
	<script type="text/javascript" src="js/shop_cat.js"></script>
<script type="text/javascript" src="js/shop.js"></script>
	<div class="r_nav">
	   <ul>
			...
			<li id="auth_page2" class="cur"><a href="defaultset.php?customer_id=<?php echo $customer_id; ?>&default_set=1">首页设置</a></li>
...
<div id="home" class="r_con_wrap" style="overflow:hidden;">
...
<?php }else if($template_id==19){?>
    ...
    <link rel="stylesheet" type="text/css" href="fruit/css/PreFoot2.css">
    <link rel="stylesheet" type="text/css" href="fruit/css/style_common.css">
	<link href="fruit/css/shop.css" rel="stylesheet" type="text/css">
     <link href="fruit/css/index.css" rel="stylesheet" type="text/css"> 
	 <link href="fruit/css/global.css" rel="stylesheet" type="text/css">
    <div id="shop_skin_index"  <?php if(!empty($index_bg)){ ?>style="background:#<?php echo $index_bg; ?>"<?php } ?>>
...
<link href="css/shop.css" rel="stylesheet" type="text/css">
<script type="text/javascript" src="js/shop_cat222.js"></script>
<div id="shop_skin_index" <?php if(!empty($index_bg)){ ?>style="background:#<?php echo $index_bg; ?>"<?php } ?>>
<div class="main">  
...
<?php } ?>
  ...
  <script type="text/javascript" src="../common/js/jscolor/jscolor.js"></script>
		<form id="frm_uploadimg" action="save_templateimg.php?customer_id=<?php echo $customer_id; ?>&template_id=<?php echo $template_id; ?>" method="post" enctype="multipart/form-data">
			...
			<div id="setimages" style="display: block;">
				<div class="item">
					...
					<div class="url_select" style="display: block;">   <!--单页图片-->
            ...
            <div id="set_video_link" style="display: none;"><!--视频链接开始-->
				<div class="item">
					<div value="title">
						...
						<div class="blank20"></div>
                        <span class="fc_red">
                        	用户进入视频网站，点击视频，在分享一栏找到通用视频代码，将"http://"开头的视频地址复制到此处即可。<br/>
	...
	if($producttype_id>0 and empty($_GET["op"])){
	   ...
	   $query="select name,parent_id,sendstyle,imgurl from weixin_commonshop_types where isvalid=true and is_shelves=1 and  id=".$producttype_id;
	   $result = mysql_query($query) or die('Query failed: ' . mysql_error());
	   while ($row = mysql_fetch_object($result)) {
                          ...
                          <div class="category no_ext">                        
                            <?php if((($owner_general==1 and $create_type==1) or ($owner_general==2 and $create_type==2)) or ($create_type==3)){ ?>
                                <span style="width:100%;text-align:center;margin:0 auto;">
                                    <a class="fenlei_a" href="defaultset.php?customer_id=<?php echo $customer_id; ?>&producttype_id=<?php echo $pt_id;?>&default_set=1" title="<?php echo $pt_name; ?>"><i class="fa fa-gear"></i><?php echo $pt_name; ?></a> 
                              </span>                                                             
                            <?php } ?>												
                         </div>
                       </dd>
	...
	<div class="m_righter" ><!--m_righter begin-->
		<form id="frm_producttype" class="" action="save_producttype_img.php?customer_id=<?php echo $customer_id; ?>&adminuser_id=<?php echo $adminuser_id; ?>&owner_general=<?php echo $owner_general; ?>&orgin_adminuser_id=<?php echo $orgin_adminuser_id; ?>" method="post" enctype="multipart/form-data" style="margin:5px 10px;">
        	<?php
			...
			?>
			<div class="">分类楼层显示数量:<input type="text" name="index_catnum" id="index_catnum" style="width:50px;" value="<?php echo $index_catnum;?>"></div><br/>			
                <div class="opt_item">			
                    <span class="upload_file">
                        <div>
                            <iframe src="product_type_catimg.php?customer_id=<?php echo $customer_id; ?>&type_imgurl=<?php echo $type_imgurl; ?>&keyid=<?php echo $producttype_id; ?>" height=200 width=100% FRAMEBORDER=0 SCROLLING=no></iframe>						
                        </div>  
                    </span>
...
<div style="display:block;overflow:hidden;">
    ...
    <div class="category" style="overflow:hidden;margin-bottom:10px;"><!--category begin-->
        <div class="m_lefter" style="margin-left:10px;height:100%;"><!--m_lefter begin-->
            <dl data-listidx="0" style="margin:5px 10px;">
             <span style="text-align:center;font-size:16px;margin-bottom:10px;display:block;">添加分类楼层广告图片</span>
                <?php 
                   $query= "select id,name,parent_id,sendstyle,is_shelves,index_catnum,create_type,asort from weixin_commonshop_types where isvalid=true and is_shelves=1 and customer_id=".$customer_id." and parent_id=-1 order by asort desc,id desc";
                   $result = mysql_query($query) or die('Query failed: ' . mysql_error());
                   while ($row = mysql_fetch_object($result)) {
                ...
                ?>
                      ...
                      <dd cateid="<?php echo $pt_id; ?>" style="cursor: pointer;">
                          <div class="category no_ext">                        
                            <?php if((($owner_general==1 and $create_type==1) or ($owner_general==2 and $create_type==2)) or ($create_type==3)){ ?>
                                <span style="width:100%;text-align:center;margin:0 auto;">
                                    <a class="fenlei_a" href="defaultset9.php?customer_id=<?php echo $customer_id; ?>&producttype_id=<?php echo $pt_id;?>&default_set=1" title="<?php echo $pt_name; ?>"><i class="fa fa-gear"></i><?php echo $pt_name; ?></a> 
                              </span>                                                             
                            <?php } ?>												
                         </div>
                       </dd>
	...
	<div class="m_righter" style="margin-bottom:20px;"><!--m_righter begin-->
		<form id="frm_producttype" class="" action="save_producttype_img.php?customer_id=<?php echo $customer_id; ?>&adminuser_id=<?php echo $adminuser_id; ?>&owner_general=<?php echo $owner_general; ?>&orgin_adminuser_id=<?php echo $orgin_adminuser_id; ?>" method="post" enctype="multipart/form-data" style="margin:5px 10px;">
			...
			<div class="">	
                ...
                <span style="margin-bottom:10px;display:block;">楼层广告图片大小为640px*320px;</span>
				...
				$result_caturl=mysql_query($cat_url) or die ('cat_url faild' .mysql_error());
                ...
                <div class="url_select" style="display: none;">
						<span class="fc_red">*</span> 链接页面<br>
						<div class="input"> 
                        <?php
							...
							elseif($caturl_cat_foreign_id>0 ){
								...
								$result_tuwen=mysql_query($tuwen) or die ('tuwen faild' .mysql_error());
								...
								if(!$tuwen_id){
										...
										$result_fenlei=mysql_query($fenlei) or die ('fenlei faild' .mysql_error());
						...
						<select  name="type_id_5"  id="type_id_5" onchange="changeProductType_cat(this.value);"><?php echo $opname;?>
						...
						<!--<div id="div_products_cat" style="display:none">
							<select name="product_detail_id_cat" id="product_detail_id_cat">
								<option value=-1>---请选择一款产品---</option>
							</select>
						</div>
                        -->
...
<?php 	
    ...
    <div class="category"><!--category begin-->
        <div class="m_lefter" style="margin-left:10px;"><!--m_lefter begin-->
            <dl data-listidx="0" style="margin:5px 10px;">
             <span style="text-align:center;font-size:16px;margin-bottom:10px;display:block;">分类首页显示图</span>
                <?php 
                ...
                ?>
                      ...
                      <dd cateid="<?php echo $pt_id; ?>" style="cursor: pointer;">
                          <div class="category no_ext">                        
                            <?php if((($owner_general==1 and $create_type==1) or ($owner_general==2 and $create_type==2)) or ($create_type==3)){ ?>
                                <span style="width:100%;text-align:center;margin:0 auto;">
                                    <a class="fenlei_a" href="defaultset.php?customer_id=<?php echo $customer_id; ?>&producttype_id=<?php echo $pt_id;?>&default_set=1&cat_op=catad" title="<?php echo $pt_name; ?>"><i class="fa fa-gear"></i><?php echo $pt_name; ?></a> 
                              </span>                                                             
                            <?php } ?>												
                         </div>
                       </dd>
                   ...
                   while ($row = mysql_fetch_object($result_son)) {
                      ...
                      <dd cateid="<?php echo $son_id; ?>" style="cursor: pointer;margin-left:30px;">
                          <div class="category no_ext">                        
                            <?php if((($owner_general==1 and $create_type==1) or ($owner_general==2 and $create_type==2)) or ($create_type==3)){ ?>
                                <span style="width:100%;text-align:center;margin:0 auto;">
                                    <a class="fenlei_a" href="defaultset.php?customer_id=<?php echo $customer_id; ?>&producttype_id=<?php echo $son_id;?>&default_set=1&cat_op=catindex" title="<?php echo $son_name; ?>"><i class="fa fa-gear"></i><?php echo $son_name; ?></a> 
                              </span>                                                             
                            <?php } ?>												
                         </div>
                       </dd>
	...
	<div class="m_righter" ><!--m_righter begin-->
		<form id="frm_producttype" class="" action="save_catindex_img.php?customer_id=<?php echo $customer_id; ?>&adminuser_id=<?php echo $adminuser_id; ?>&owner_general=<?php echo $owner_general; ?>&orgin_adminuser_id=<?php echo $orgin_adminuser_id; ?>" method="post" enctype="multipart/form-data" style="margin:5px 10px;">
        	
			<div class="">	
                <div class="opt_item">			
                    <span class="upload_file">
                        <div>
                            <iframe src="product_cat_indeximg.php?customer_id=<?php echo $customer_id; ?>&type_imgurl=<?php echo $cat_index_imgurl; ?>&keyid=<?php echo $producttype_id; ?>" height=200 width=100% FRAMEBORDER=0 SCROLLING=no></iframe>						
                        </div>  
                    </span>
