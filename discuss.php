			...
			<tr class="WSY_q1">
				...
				<td class="WSY_t4">
					...
					<?php }else{ 
						if($type != 3){
					?>					
					<a href="discuss_reply.php?keyid=<?php echo $d_id; ?>&pid=<?php echo $pid; ?>" style="cursor:pointer;" class="WSY_operation" title="商家回复"><img src="../common/images_V6.0/operating_icon/icon11.png"></a>		
					<?php } ?>					
