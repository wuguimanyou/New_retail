...
<div id="shop_skin_index" <?php if(!empty($index_bg)){ ?>style="background:#<?php echo $index_bg; ?>"<?php } ?>>
	<div class="main">
        ...
        <div class="content-box">
            ...
            <div class="icon-box">            
                <div class="shop_skin_index_list" rel="edit-t09" no="9">
                    <div class="img"></div>
                </div>
                <p>
                    <div class="name shop_skin_index_list" rel="edit-t17" no="16">
        ...
        <div class="dapai">
            ...
            <div class="skin-care">
                <img class="title" src="fengge42/images/hufu-title.jpg">
                <div class="content">
                    <div class="left-box"><img src="fengge42/images/hufu1.jpg"></div>
                    <div class="right-box">
                        <img src="fengge42/images/hufu2.jpg" class="hufu2">
                        <img src="fengge42/images/hufu3.jpg" class="hufu3">
                    </div>
                    <div class="clear"></div>
                </div>
            </div>
...
<?php } ?>
  ...
  <script type="text/javascript" src="../common/js/jscolor/jscolor.js"></script>
        ...
        <!--分类图片-->
    <?php if($template_id==38 or $template_id==42){?>
    <?php 	
	$producttype_id=-1;
	$btn="添加分类";
                ...
                <div class="opt_item">			
                    <span class="upload_file">
                        <div>
                            ...
                            <?php if($template_id==38){echo "上传1张图片，作为首页的图片。图片大小建议：640*110像素";}elseif($template_id==42){echo "上传1张图片，作为首页楼层分类图片。图片大小建议：640*55像素";}?>						
                        </div>     
                    </span>
