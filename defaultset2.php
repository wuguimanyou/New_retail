...
<script type="text/javascript" src="js/shop.js"></script>
	<div class="r_nav">
	   <ul>
			...
			<li class="cur"><a href="defaultset.php?customer_id=<?php echo $customer_id_en; ?>">首页设置</a></li>
			<li class=""><a href="product.php?customer_id=<?php echo $customer_id_en; ?>">产品管理</a></li>
			<li class=""><a href="order.php?customer_id=<?php echo $customer_id_en; ?>&status=-1">订单管理</a></li>
			<li class=""><a href="qrsell.php?customer_id=<?php echo $customer_id_en; ?>">推广员</a></li>
			<li class=""><a href="customers.php?customer_id=<?php echo $customer_id_en; ?>">顾客</a></li>
	   </ul>
	</div>
...
<script language="javascript">
  ...
  while ($row = mysql_fetch_object($result)) {
	  ...
	  $detail_id=-1;
	  //如果客户已经替换了图片，则用客户的图片
	  $query2="select id,imgurl,position,url,linktype,foreign_id,title,detail_id from weixin_commonshop_template_item_imgs where isvalid=true  and template_id=".$template_id." and customer_id=".$customer_id." and position=".$position;
			...
			<div id="setbanner" style="display: none;">
				<div class="item">
					...
					<div class="rows url_select" style="display: block;">
					   ...
					   <div id="div_products_1_1" style="display:block;padding-left:72px;">
					...
					<div class="rows url_select" style="display: block;">
						...
						<div id="div_products_1_2" style="display:block;padding-left:72px;">
					...
					<div id="div_products_1_3" style="display:block;padding-left:72px;">
					...
					<div class="rows url_select" style="display: block;">
					  ...
					  <div id="div_products_1_4" style="display:block;padding-left:72px;">
					...
					<div class="rows url_select" style="display: block;">
						...
						<div id="div_products_1_5" style="display:block;padding-left:72px;">
               ...
               if($is_shopgeneral){				
				...
				?>
					...
					<div class="rows url_select" style="display: block;">
						...
						<div id="div_products_1_<?php echo $num; ?>" style="display:block;padding-left:72px;">
