			...
			<tbody>
				...
				while ($row2 = mysql_fetch_object($result2)) {
	             ...
	             while ($row = mysql_fetch_object($result)) {				 
					...
					/*$query2="select sum(totalprice) as totalprice from weixin_commonshop_orders wco where  status=1 and  wco.isvalid=true and wco.user_id=".$user_id;
					...
					$totalprice_3 = 0;
				    while ($row2 = mysql_fetch_object($result2)) {
					   $totalprice_1 = $row2->total_money;
					}
					if($totalprice_1==''){
						$totalprice_1 = 0;
					}
					/* 原查询未支付金额 
					$query2="select sum(totalprice) as totalprice from weixin_commonshop_orders  where  paystatus=0 and  isvalid=true and user_id=".$user_id;
					$result2 = mysql_query($query2) or die('Query failed: ' . mysql_error());
					while ($row2 = mysql_fetch_object($result2)) {
					...
					*/
					...
					$query2="select sum(totalprice) as totalprice from weixin_commonshop_orders wco where  paystatus=1 and  wco.isvalid=true and wco.user_id=".$user_id;
					$result2 = mysql_query($query2) or die('Query failed: ' . mysql_error());
					$totalprice_3 = 0;
				    while ($row2 = mysql_fetch_object($result2)) {
                ...
                <tr>
					...
					<td align="center">
						<a href="../../Order/order/order.php?customer_id=<?php echo $customer_id_en; ?>&search_class=3&user_id=<?php echo $user_id; ?>"><?php echo $totalprice_1; ?></a>
					</td >	
					<td align="center">
						<a href="../../Order/order/order.php?customer_id=<?php echo $customer_id_en; ?>&search_class=1&user_id=<?php echo $user_id; ?>"><?php echo $totalprice_2; ?></a>
					</td>
					<td align="center">	
						<a href="../../Order/order/order.php?customer_id=<?php echo $customer_id_en; ?>&search_class=8&user_id=<?php echo $user_id; ?>"><?php echo $totalprice_3; ?></a>
					</td>
